              ...
              child: Stack(
                children: [
                  ...
                  SlideTransition(
                    ...
                    child: Image.asset('images/logo-3.png', width: 100, height: 100),
                  ),
                  // Logo part 2 (from bottom)
                  SlideTransition(
                    position: _logo2Animation,
                    child: Image.asset('images/logo-1.png', width: 100, height: 100),
                  ),
                  // Logo part 3 (from left)
                  SlideTransition(
                    position: _logo3Animation,
                    child: Image.asset('images/logo-2.png', width: 100, height: 100),
                  ),
                  // Logo part 4 (from right, with words)
                  SlideTransition(
                    position: _logo4Animation,
                    child: Image.asset('images/logo-4.png', width: 100, height: 100),
                  ),
                ],
              ),
            ),
